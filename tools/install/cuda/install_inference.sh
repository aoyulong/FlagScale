#!/bin/bash
# Inference dependency installation script for CUDA platform
# Installs inference-specific dependencies (requirements is one type of dependency)
...
PLATFORM="cuda"
TASK_NAME="inference"
DEFAULT_ENV_NAME="flagscale-inference"
